...
const AdCard = () => {
  return (
    <Link
      href="product-detail"
      className="mb-4 flex h-[277px] w-[166px] cursor-pointer flex-col  gap-3 rounded-md p-2 transition-all duration-700 hover:rounded-lg hover:border hover:border-[#0170b4] hover:bg-[rgba(1,112,180,.08)] "
    >
      <Image
        src="https://picsum.photos/id/5/148/140"
        width={148}
        height={140}
        alt="image"
      ...
      <div className="flex gap-2">
        <h2 className="text-xs">Rs.1,70,00,000</h2>
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
